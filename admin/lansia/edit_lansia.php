	...
	<form action="" method="post" enctype="multipart/form-data">
		<div class="card-body">
			...
			<div class="form-group row">
				...
				<div class="col-sm-6">
					<input type="text" class="form-control" id="nama_anak" name="nama_anak" value="<?php echo $data_cek['nama_anak']; ?>" />
				</div>
			</div>
			...
			<div class="form-group row">
				...
				<div class="col-sm-6">
					<input type="number" class="form-control" id="nik_anak" name="nik_anak" value="<?php echo $data_cek['nik_anak']; ?>" />
				</div>
			</div>
			...
			<div class="form-group row">
				...
				<div class="col-sm-6">
					<input type="number" class="form-control" id="nik_ibu" name="nik_ibu" value="<?php echo $data_cek['nik_anak']; ?>" />
				</div>
			</div>
