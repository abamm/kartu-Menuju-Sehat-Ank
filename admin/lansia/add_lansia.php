...
<div class="card card-info ">
	<div class="card-header">
		<h3 class="card-title">
			<i class="fa fa-edit"></i> Tambah Data Anak
		</h3>
	</div>
	<form action="" method="post" enctype="multipart/form-data">
		<div class="card-body">
			...
			<div class="form-group row">
				...
				<div class="col-sm-6">
					<input type="text" class="form-control" id="nama_anak" name="nama_anak" placeholder="Nama Anak" required> <!-- namapasien -->
				</div>
			</div>

			<div class="form-group row">
				<label class="col-sm-2 col-form-label">NIK Anak</label>
				<div class="col-sm-6">
					<input type="number" class="form-control" id="nik_anak" name="nik_anak" placeholder="NIK Anak">
				</div>
			</div>
			...
			<div class="form-group row">
				<label class="col-sm-2 col-form-label">Jenis Kelamin Anak</label>
				<div class="col-sm-3">
			...
			<div class="form-group row">
				<label class="col-sm-2 col-form-label">Tempat/Tgl Lahir Anak</label>
				<div class="col-sm-3">
					<input type="text" class="form-control" id="tempat_lh" name="tempat_lh" placeholder="Tempat Lahir">
				</div>
				<div class="col-sm-3">
					<input type="date" class="form-control" id="tgl_lh" name="tgl_lh" placeholder="Tanggal Lahir" value="">
				</div>
			</div>
			...
			<div class="form-group row">
				...
				<div class="col-sm-3">
					<input type="number" class="form-control" id="no_telepon" name="no_telepon" placeholder="HP">
				</div>
			</div>
		...
		<!-- </div>asddddddddddddddddddddddddddddddddddddddddddddddddddddddddasdadasdadmaskdjakdjeowfjklsdjfiojlkjaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa -->
...
if (isset($_POST['Simpan'])) {
	...
	$sql_simpan = "INSERT INTO tb_pasien (nama_anak, nama_ibu, jekel, tempat_lh, tgl_lh, nik_anak, nik_ibu, alamat, rt, rw, kode_pos, no_telepon, tempat_tinggal, agama, 
	suku, didik_akhir, nik, gol_d, hobi, bpjs, asuransi_lain, sumber_dn, status) VALUES (
		    ...
		    $query_create_table = mysqli_query($koneksi, $sql_create_table);

		    // Jika berhasil membuat tabel
		    if ($query_create_table) {
		        echo "Tabel berhasil dibuat atau sudah ada.";
		    } else {
		        echo "Error: " . $sql_create_table . "<br>" . mysqli_error($koneksi);
		    }
	...
	// Simpan nilai beratb ke dalam tabel anak yang sesuai
    // $sql_simpan_beratb = "INSERT INTO $nama_tabel (beratb) VALUES ('" . $_POST['beratb'] . "')";
    // $query_simpan_beratb = mysqli_query($koneksi, $sql_simpan_beratb);
