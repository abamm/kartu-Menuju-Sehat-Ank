<div class="card card-info">
    <div class="card-header">
        <h3 class="card-title">
            <i class="fa fa-table"></i> Data Lansia Sehat
        </h3>
    </div>
    <!-- /.card-header -->
    <div class="card-body">
            ...
            <div class="table-responsive">
                ...
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        $no = 1;
                        $sql = $koneksi->query("SELECT p.id_pasien, p.nama_anak, p.nik_anak, p.nama_ibu, p.jekel, p.nik_ibu, p.alamat, p.rt, p.rw, p.no_telepon, a.id_kk, k.no_kk, k.kepala from 
			  tb_pasien p left join tb_anggota a on p.id_pasien=a.id_pasien 
			  left join tb_kk k on a.id_kk=k.id_kk where status='Sehat'");
                        ...
                        ?>
                            ...
                            <tr>
                                ...
                                <style>
                                    .btn-KMS {
                                        background-color: pink; /* Warna bingkai */
                                        border-color: pink; /* Warna bingkai */
                                ...
                                <td>
                                    ...
                                    <a href="?page=KMS&kode=<?php echo $data['id_pasien']; ?>" title="KMS" class="btn btn-KMS btn-sm">
